namespace Colorspace
{
  public static class ColorScaling
  {
    ...
    public static readonly Matrix3x3 D50_D65_Bradford = new double[,]
        {
    ...
    public static readonly Matrix3x3 D65_D50_Linear = new double[,]
        {
    ...
    public static readonly Matrix3x3 D50_D65_Linear = new double[,]
        {
